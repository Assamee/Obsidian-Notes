...
> [!Summary] 
> **Theory:** This file covers Matrix Decompositions and Linear Regression, used for solving real-world data systems
> **Content:** LU Decomposition, PLU Decomposition, QR Decomposition, Least Squares Approximation & Linear Regression 
---
...
---
#### Example: Calculating LU Decomposition
...
> [!info] Prerequisite 
> To find matrix $Q$, you must first apply the [[Inner Product Spaces and Orthogonality#The Gram-Schmidt Process|Gram-Schmidt Process]] to the column vectors of matrix $A$.

---
#### QR Decomposition Algorithm: Factoring into $Q$ and $R$
...
---
### Least Squares Approximation (Not done yet)
#### The Normal Equations
#### Solving with QR

## Linear Regression (Not Done Yet)
### Translating Data to Matrices
### Finding the Line of Best Fit

---
#linear-algebra/applied #linear-algebra/lu-decomposition #linear-algebra/plu-decomposition #linear-algebra/qr-decomposition #linear-algebra/least-squares #linear-algebra/linear-regression