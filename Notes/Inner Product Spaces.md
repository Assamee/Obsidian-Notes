...
\langle u, v \rangle &= \langle v, u \rangle \quad \blacksquare
\end{aligned}
$$
...
\langle u+v, w \rangle &= \langle u, w \rangle + \langle v, w \rangle \quad \blacksquare
\end{aligned}
$$
###### 3. Homogeneity Proof: 
...
\langle ku, v \rangle  &= k\langle u, v \rangle \quad \blacksquare
\end{aligned}
$$
###### 4. Positivity Proof: 
...
$$\begin{aligned} 
\textbf{Part A: } & \text{Show } \langle v, v \rangle \geqslant 0 \\ \langle v, v \rangle &= v_1 v_1 + v_2 v_2 + \dots + v_n v_n \\ 
...
&\therefore \sum_{i=1}^{n} v_i^2 \geqslant 0 \implies \langle v, v \rangle \geqslant 0 \\[1em]

\textbf{Part B: } & \text{Show } \langle v, v \rangle = 0 \iff v = \mathbf{0} \\ 
\langle v, v \rangle &= 0 \\ % Comments
\sum_{i=1}^{n} v_i^2 &= 0 \\ 
\implies v_i^2 &= 0 \text{ for all } i && \text{(Sum is 0 only if all terms are 0)} \\ 
\implies v_i &= 0 \text{ for all } i \\ 
\therefore v &= \mathbf{0} \quad \blacksquare \\[1em]
